...
from parserthere import DFG_python,DFG_java,DFG_ruby,DFG_go,DFG_php,DFG_javascript,DFG_csharp,DFG_c
from parserthere import (remove_comments_and_docstrings,
                   tree_to_token_index,
                   index_to_code_token,
...
def corpus_dataflow_match(references, candidates, lang):   
    LANGUAGE = Language(os.path.dirname(__file__) + '/parserthere/my-languages.so', lang)
    parser = Parser()
